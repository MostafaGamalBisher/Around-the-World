            ...
            <div className="flex flex-col gap-8 md:gap-40 lg:flex-row">
              <div className="flex flex-col gap-5">
                <p>
                  ...
                  <span className="font-light">Ana we bass</span>
                </p>

                <p>
                  <span className="font-semibold">Region: </span>
                  <span>Ismailia Kaman we Kaman</span>
                </p>

                <p>
                  <span className="font-semibold">Sub Region: </span>
                  <span>Ismailia bardo</span>
                </p>
              ...
              <div className="flex flex-col gap-5">
                ...
                <p>
                  ...
                  <span className="font-thin">Dollar</span>
                </p>

                <p>
                  <span className="font-semibold">Languages: </span>
                  <span className="font-thin">arabic</span>
                </p>
              </div>
            </div>
          </div>
